...
class TestAPIFIDSSchedulesAirportDeparturesTimeRelative(unittest.TestCase):
    ...
    def test_fids_Schedules_airport_departures_relative_time(self):
        """
        Tests the API endpoint for retrieving FIDS getting updated flights schedule per specific airports relative to the current time.
        """
        logging.info("______________")
        logging.info("Starting the 'FIDS Schedules airport departures relative time' test")
